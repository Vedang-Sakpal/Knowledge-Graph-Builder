...
def main():
    ...
    ONTOLOGY_PATH = "Ontology/Storage Tank Ontology.rdf" # CHANGED: Assumes files are in same directory
    OUTPUT_PATH = "Results/storage_tank_descriptions.txt" # CHANGED: Assumes files are in same directory
