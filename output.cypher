...
MERGE (c:Cause {description: "Operator error, e.g., shift handover. MV307 closed after maintenance"});
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Start-up check to confirm that MV307 is open", assigned: "TB", ref: "1.1"});
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "F2 not fully emptied from last batch"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Operating procedure to include a check on vessel F2 before B is measured out", assigned: "TB", ref: "2.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Blockage in line or at OP1"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Check procedure for clearing line and OP1 when transfer line holds component B", assigned: "FL", ref: "3.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Error at earlier stage resulting in small excess (double charging covered in HAZOP of addition step)"});
MERGE (dev)-[:HAS_CAUSE]->(c);
MERGE (con:Consequence {description: "Batch out of specification and process delay"});
MERGE (dev)-[:LEADS_TO]->(con);
MERGE (s:Safeguard {description: "Detected at sampling"});
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Check that procedure will be written to cover this case and include in training program", assigned: "JH", ref: "4.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Error at earlier stage resulting in small deficiency"});
MERGE (dev)-[:HAS_CAUSE]->(c);
MERGE (con:Consequence {description: "Batch out of specification and process delay. Not easily corrected"});
MERGE (dev)-[:LEADS_TO]->(con);
MERGE (s:Safeguard {description: "Detected at sampling"});
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Evaluate likelihood of this deviation and, if necessary, draw up procedure", assigned: "MS", ref: "5.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Corrosion/erosion of OP1"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Check that OP1 material is compatible with component B", assigned: "BT", ref: "6.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Wrong OP fitted at OP1 after maintenance"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "7.1 Specify OP1 size in operating procedure and ensure problem is covered in operator training", assigned: "TB", ref: "7.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "MV306 is open and so orifice plate OP1 is bypassed"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "8.1 MV306 to be locked closed as it is not used in this process", assigned: "FL", ref: "8.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Partial blockage in line or at orifice plate OP1"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Covered by actions 3.1 and 3.2", assigned: "FL", ref: "9.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Crack or leak at BD2 (action 8.2 only detects full burst)"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Put BD2 on a regular checking schedule", assigned: "FL", ref: "10.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Control problem or faulty temperature signal (reads low)"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Check whether it is possible to physically separate the two temperature probes (control and protection) to reduce common cause effects", assigned: "FL", ref: "11.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Loss of cooling water (a low probability event)"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Covered by action 7.3", assigned: "AW", ref: "12.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Jacket not switched from steam to cooling water after earlier step"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Control program to include checks that valve CV301 on the steam line is closed", assigned: "AW", ref: "13.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Control problem or faulty temperature signal (reads high)"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "14.1 Take TAL from both the control and the protection temperature sensors", assigned: "AW", ref: "14.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "No causes identified in addition to the runaway situations discussed above"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "No additional causes found"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Mechanical coupling fails or agitator blade becomes detached"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Add a rotation sensor to the shaft of the stirrer; interlock to reactant feed valve AV203", assigned: "AW", ref: "17.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Motor failure"});
MERGE (dev)-[:HAS_CAUSE]->(c);
MERGE (con:Consequence {description: "Risk of accumulation of unmixed B leading to uncontrolled reaction"});
MERGE (dev)-[:LEADS_TO]->(con);
MERGE (s:Safeguard {description: "Alarm on motor current (low)"});
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "18.1 Existing safeguard adequate provided action 17.1 is implemented", assigned: "AW", ref: "18.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Viscous mixture formed"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Check viscosity under extreme conditions to decide if action is needed. If so, include an alarm on high motor current", assigned: "BT", ref: "19.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Incorrect connection after maintenance"});
MERGE (dev)-[:HAS_CAUSE]->(c);
MERGE (con:Consequence {description: "Stirring becomes inefficient and unmixed B may accumulate"});
MERGE (dev)-[:LEADS_TO]->(con);
MERGE (s:Safeguard {description: "None"});
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Include a check on stirrer operation in the commissioning trials and in the maintenance procedures", assigned: "TB", ref: "20.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Wrong ratio of reactants covered under high/low quantity"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Wrong drum used when charging component B"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Review actions from earlier HAZOP and ensure that the purchasing department specifies a distinct drum color", assigned: "MS", ref: "22.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Complete loss of control computer"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Check that fail safe settings include isolation of feed of B, continued stirring and full cooling to vessel jacket", assigned: "AW", ref: "23.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Selective failure. Most serious: loss of temperature sensors/control"});
MERGE (dev)-[:HAS_CAUSE]->(c);
MERGE (con:Consequence {description: "Possible undetected overheating"});
MERGE (dev)-[:LEADS_TO]->(con);
MERGE (s:Safeguard {description: "Ultimate protection is provided by BD2"});
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Check that the temperature sensors connect to different input boards", assigned: "AW", ref: "24.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Step started early"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (s:Safeguard {description: "Ultimate protection is provided by BD2"});
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Specify the lowest safe starting temperature", assigned: "BT", ref: "25.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Workout period is shortened if the addition is slow (for any reason)"});
MERGE (dev)-[:HAS_CAUSE]->(c);
MERGE (con:Consequence {description: "Uncertain—basis for inclusion of the workout period is not clear"});
MERGE (dev)-[:LEADS_TO]->(con);
MERGE (a:Action {description: "Carry out further laboratory work to determine the importance of the workout and to define the minimum allowable time", assigned: "BT", ref: "26.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (dev)-[:LEADS_TO]->(con);
MERGE (a:Action {description: "Review the failure modes of all valves to ensure specification is correct", assigned: "JH", ref: "27.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Unpredicted failure, cut cable, and so on"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Include this condition in the check under 27.1", assigned: "AW", ref: "28.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Valve problem on AV203 during the transfer"});
MERGE (dev)-[:HAS_CAUSE]->(c);
MERGE (con:Consequence {description: "AV203 cannot be isolated from F2 for safe maintenance"});
MERGE (dev)-[:LEADS_TO]->(con);
MERGE (s:Safeguard {description: "None"});
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Put additional manual valves in the F2/F3 line", assigned: "FL", ref: "29.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Inspection or other requirement for entry to vessel"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Review the isolation of F3, including possible insertion of flexible section into the nitrogen line so it can be disconnected and blanked off. Need to cover F2 as well since it has its own nitrogen supply and is linked to F3", assigned: "MS", ref: "30.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Leaking flange on transfer line from F2 to F3"});
MERGE (dev)-[:HAS_CAUSE]->(c);
...
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Check the materials in use on adjacent units for potential incompatibility", assigned: "FL", ref: "31.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Imbalance in quantities of A or caustic added previously"});
MERGE (dev)-[:HAS_CAUSE]->(c);
MERGE (con:Consequence {description: "Batch quality affected unless initial pH is range 10—11.5"});
MERGE (dev)-[:LEADS_TO]->(con);
MERGE (s:Safeguard {description: "None"});
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Operating procedure to include a check on pH before this step is initiated", assigned: "TB", ref: "32.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Any"});
MERGE (dev)-[:HAS_CAUSE]->(c);
MERGE (con:Consequence {description: "Control system moves the plant to a predetermined state based on the trip signals"});
MERGE (dev)-[:LEADS_TO]->(con);
MERGE (a:Action {description: "Prepare matrix to show which valves act in each trip scenario. Review the matrix at next HAZOP meeting", assigned: "JH", ref: "33.1"});
MERGE (dev)-[:HAS_ACTION]->(a);
...
MERGE (param)-[:HAS_DEVIATION]->(dev);
MERGE (c:Cause {description: "Leakage or spillage"});
MERGE (dev)-[:HAS_CAUSE]->(c);
MERGE (con:Consequence {description: "Contamination"});
MERGE (dev)-[:LEADS_TO]->(con);
MERGE (s:Safeguard {description: "Standard procedures"});
MERGE (dev)-[:HAS_SAFEGUARD]->(s);
MERGE (a:Action {description: "Confirm that procedures exist for all materials handled in the process", assigned: "TB", ref: "34.1"});
MERGE (dev)-[:HAS_ACTION]->(a); 
